...
## Objective
Create RESTful API controllers for all domain entities with proper CRUD operations, error handling, and Swagger documentation.
...
All controllers include XML documentation comments for Swagger:
